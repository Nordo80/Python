...
def alph_sort_dict(dictionary: dict):
    """
    Return alphabetically sorted dictionary(values as well).

    :param dictionary: dict to be sorted
    :return: sorted dict
    """
...
def write_corrected_database(file, file_to_write):
    ...
    """
    dictionary = alph_sort_dict(create_dictionary(file))
